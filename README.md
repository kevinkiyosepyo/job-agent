...
- `browser_actions.py` — deterministic browser-action contracts for text replacement, native-option selection, and radio/checkbox state changes; each requires exact post-action read-back evidence before an action is considered verified.
