...
- `browser_actions.py` — deterministic browser-action contracts for text replacement and native-option selection; each requires exact post-action read-back evidence before an action is considered verified.
